...
香港兽医账单里的 consultation、procedure、medication 是什么？为什么这么贵？

## 简明解释

香港兽医账单常见项目包括 consultation（诊金）、procedure（治疗/手术）、medication（药物）、diagnostic（化验/影像）、hospitalization（住院）、vaccination（疫苗）等。费用以港币（HKD）计算。PetVault 只能解释类别和核对点，不能替医院判断价格是否合理。
